...
//    private JTextField info = new JTextField(10);
    ...
    private boolean servertDone=false;
...
//                            System.out.println("i:"+i+"["+linelist[i]);
                            ...
                            {
                                if(line[j].equals("SEA"))checkerBoard1.Set_Grid_according_to_location(i,j,new Grid(GridType.SEA));
                                if(line[j].equals("SHIP"))checkerBoard1.Set_Grid_according_to_location(i,j,new Grid(GridType.SHIP));

                            }
                        }
                        checkerBoard1.setSetup(true);
                    ...
                    else if(str.contains("Hit:"))
                    {
                        ...
                        checkerBoard2.Set_Grid_according_to_location(px,py,new Grid(type));
                        Repaint();
                    }
    ...
    void addButtons(CheckerBoard checkerBoard)
    {
        ...
        randombtn.setBounds(width/2+200, 600, 100, 50);
...
//                System.out.println("addaction"+checkerBoard.title);
        ...
        yesbtn.setBounds(width/2+400, 600, 100, 50);

        yesbtn.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                if(checkerBoard.getSetup()) {
//                    addButtons(checkerBoard2);
                    Repaint();
                    sentMag("clientsetDone\n");
